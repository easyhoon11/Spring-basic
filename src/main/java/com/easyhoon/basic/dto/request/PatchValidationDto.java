...
public class PatchValidationDto {
    ...
    // description: build.gradle의 dependencies에 inplementation 'org.springframework.boot:spring-boot-starter-validation'을 추가해야함 //

    // description: @NotNull - 해당 멤버 변수를 필수값으로 지정 //
    // @NotNull
    ...
    // description: @Email 문자열이 이메일 형식만 올 수 있도록 함 //
    @Email
    private String arg3;
